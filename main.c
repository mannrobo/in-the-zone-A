#pragma config(Motor,  port1,           clawMotor,     tmotorNone, openLoop)
#pragma config(Motor,  port2,           leftLiftMotor, tmotorVex393_MC29, openLoop)
...
#pragma config(Motor,  port9,           rightLiftMotor, tmotorVex393_MC29, openLoop)
